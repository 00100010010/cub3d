...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   read_tex_tools_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jtrebes <jtrebes@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/27 18:07:55 by jtrebes           #+#    #+#             */
/*   Updated: 2020/11/08 13:00:46 by jtrebes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			check_txtrs(t_c *c)
{
	...
	&& c->txtrs.wall_ea.name && c->txtrs.sprt.name)
		c->check.txtrs = 1;
	if (c->check.txtrs && !c->txtrs.sky.rgb_flag &&
	!ft_strncmp(c->txtrs.sky.name, "textures/opensky.xpm", 20))
		c->txtrs.sky.full_option = 1;
}
